...
class __TwigTemplate_74d68de5ff8d03b8041fdc422888d0bde4a51895ba7fa624541fd3f76f8c60f2 extends Twig_Template
{
    ...
    <h3><a href=\"";
        // line 7
        echo $this->env->getExtension('Symfony\Bridge\Twig\Extension\RoutingExtension')->getPath("family_new");
        echo "\">Register Your Family</a></h3>
    <h3><a href=\"";
        // line 8
        echo $this->env->getExtension('Symfony\Bridge\Twig\Extension\RoutingExtension')->getPath("family_list");
        echo "\">All Families</a></h3>
    <h3><a href=\"";
        // line 9
        echo $this->env->getExtension('Symfony\Bridge\Twig\Extension\RoutingExtension')->getPath("family_stats");
        echo "\">Family's Stats</a></h3>
...
{% block body %}
    ...
    <h3><a href=\"{{ path('family_new') }}\">Register Your Family</a></h3>
    <h3><a href=\"{{ path('family_list') }}\">All Families</a></h3>
    <h3><a href=\"{{ path('family_stats') }}\">Family's Stats</a></h3>

{% endblock %}", "default/homepage.html.twig", "/home/jaca/Workspace/Symfony/project_family/app/Resources/views/default/homepage.html.twig");
    }
}
