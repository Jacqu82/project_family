...
return $this->services['form.registry'] = new \Symfony\Component\Form\FormRegistry(array(0 => new \Symfony\Component\Form\Extension\DependencyInjection\DependencyInjectionExtension(new \Symfony\Component\DependencyInjection\ServiceLocator(array('AppBundle\\Form\\ChildEmbeddedForm' => function () {
    return ${($_ = isset($this->services['AppBundle\Form\ChildEmbeddedForm']) ? $this->services['AppBundle\Form\ChildEmbeddedForm'] : $this->services['AppBundle\Form\ChildEmbeddedForm'] = new \AppBundle\Form\ChildEmbeddedForm()) && false ?: '_'};
}, 'AppBundle\\Form\\DownloadType' => function () {
    return ${($_ = isset($this->services['AppBundle\Form\DownloadType']) ? $this->services['AppBundle\Form\DownloadType'] : $this->services['AppBundle\Form\DownloadType'] = new \AppBundle\Form\DownloadType()) && false ?: '_'};
}, 'AppBundle\\Form\\FamilyType' => function () {
    return ${($_ = isset($this->services['AppBundle\Form\FamilyType']) ? $this->services['AppBundle\Form\FamilyType'] : $this->services['AppBundle\Form\FamilyType'] = new \AppBundle\Form\FamilyType()) && false ?: '_'};
